...
<div class="container-fluid">
  ...
  loading="lazy"
/>
Kentucky Fried Chicken Tabla Area</a>
...
echo "<th><p>Empleados</th></p>";
echo "<th><p>Horas</th></p>";
while ($registro = $datos->fetch_assoc()){
//$registro = $datos->fetch_array(MYSQLI_ASSOC);
echo '
            <tr>           
                <td>'.$registro["nombre"].'</td>
                <td>'.$registro["EmpleadosRequerido"].'</td>
                <td>'.$registro["HorasRequeridas"].'</td>
                <td><a href="FormUpdArea.php?idArea='.$registro["idArea"].'"><i class="bi bi-pencil-square"></i>
                <td><a href="DelArea.php?idArea='.$registro["idArea"].'" onclick="return confirm(\'¿Estás seguro de que deseas eliminar este registro?\')">
                <i class="bi bi-trash-fill"></i>';
 echo "</tr>";
}
echo"</table>";

echo'<td><a href="ForminserArea.html"><i class="bi bi-plus-square"></i>';

echo '<a class="export-button" href="exportar_pdfA.php">Exportar a PDF</a>';
echo '<a class="export-button" href="ExcelA.php"> Exportar a Excel</a>';
echo '<a class="export-button" href="CsvA.php"> Exportar a Csv</a>';
echo '<a class="export-button" href="XmlA.php"> Exportar a Xml</a>';
echo '<a class="export-button" href="JsonA.php"> Exportar a Json</a>';
